...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="bg-linear-to-r from-gray-900 to-gray-700 py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-extrabold text-white mb-6">About Ingush State University</h1>
      ...
      <section id='history' className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-linear-to-br from-blue-100 to-blue-50 rounded-lg overflow-clip shadow-lg h-96 flex items-center justify-center">
      ...
      <section id='mission' className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-extrabold text-gray-800 text-center mb-16">Our Mission & Vision</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-extrabold text-gray-800 text-center mb-16">Why Choose Ingush State University?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-extrabold text-gray-800 text-center mb-16">Our Journey</h2>
